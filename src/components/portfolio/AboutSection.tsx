        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-3 flex-1 w-full lg:w-auto">
            <div className="relative flex flex-col gap-4">
              <div className="lg:absolute lg:-top-14 inline-flex items-center gap-3 px-4 py-2 rounded-full border border-brand-stroke/20 bg-white/[0.02] backdrop-blur-sm w-fit">
