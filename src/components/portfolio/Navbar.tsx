...
const AGLogo = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <defs>
      <linearGradient id="navGrad" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-6">
      <nav
        className={`flex items-center justify-between w-full max-w-[1240px] px-4 py-4 rounded-full border border-white/20 transition-all duration-300 ${scrolled ? "backdrop-blur-xl bg-black/30" : "backdrop-blur-[10px] bg-black/10"
          }`}
      >
        {/* Logo */}
