    ...
    <aside className="w-full lg:w-80 flex flex-col gap-8">
      ...
      <div className="relative p-6 rounded-2xl bg-white/5 border border-white/10 group overflow-hidden">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div>
            <h3 className="text-xl font-archivo text-white">Andrés Gutiérrez</h3>
            <p className="text-xs font-space-grotesk text-brand tracking-wider uppercase">Software Engineer</p>
          </div>
          <p className="text-sm font-space-grotesk text-white/60 leading-relaxed">
            Writing about the things I genuinely find interesting — cloud infra, full-stack dev, hardware, and the occasional engineering opinion.
          </p>
          <button className="flex items-center justify-between w-full px-4 py-3 rounded-full bg-brand group-hover:bg-brand/90 transition-all text-brand-950 font-space-grotesk font-medium text-sm">
            Say hello
            <div className="w-6 h-6 rounded-full bg-brand-950 flex items-center justify-center">
        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            <div key={topic.name} className="flex items-center justify-between group cursor-pointer">
              <span className="text-base font-space-grotesk text-white/60 group-hover:text-white transition-colors">{topic.name}</span>
      ...
      <div className="relative p-6 rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
        ...
        <h3 className="text-xl font-archivo text-white mb-2">Stay in the loop</h3>
        <p className="text-sm font-space-grotesk text-white/60 mb-6">
          New post every couple of weeks. No spam, no newsletters about newsletters.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button className="flex items-center justify-between w-full px-4 py-3 rounded-full bg-brand text-brand-950 font-space-grotesk font-medium text-sm">
            Subscribe
            <div className="w-6 h-6 rounded-full bg-brand-950 flex items-center justify-center">
              <ArrowRight className="w-3 h-3 text-brand" />
            </div>
