...
export default function BackgroundRays({ opacity = 0.15, className = "", showGlow = true }: BackgroundRaysProps) {
  return (
    <div className={`absolute top-0 left-0 w-full h-[1200px] overflow-hidden pointer-events-none ${className}`}>
      {/* Background Glow */}
      {showGlow && (
